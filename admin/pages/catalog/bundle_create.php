...
<div class="page-header">
    <div class="page-header-content">
        <nav class="breadcrumb"><a href="?page=catalog/bundles">Bundles</a> <span>›</span> <span>Neues Bundle</span>
        </nav>
        <h1>Neues Bundle erstellen</h1>
        <p class="page-subtitle">Erstellen Sie ein Produktpaket mit Rabatt</p>
    </div>
        ...
        <div class="bundle-main">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <p class="form-hint" style="margin-top:12px;">Mindestens 2 Produkte müssen ausgewählt werden. Die
                        Menge gibt an, wie oft das Produkt im Bundle enthalten ist.</p>
                </div>
            </div>
        </div>
...
<script>
    const BundleForm = {
        products: [],
        selectedProducts: {}, // {productId: {id, name, sku, price, quantity}} - prices always in shop's default currency
        currencies: [],
        currencyPrices: {}, // {currencyCode: overridePrice}
        baseCurrency: 'EUR',
        baseCurrencySymbol: '€',
        ...
        updatePricing() {
            ...
            // (because product.price is always stored in shop's default currency)
        ...
        calculateBundlePrice() {
            ...
            switch (priceType) {
                case 'percentage':
                    ...
                    break;
                case 'fixed_discount':
                    // Discount is entered in base currency
                    savings = discountValue;
                    bundlePrice = Math.max(0, totalProductPrice - discountValue);
                    break;
                case 'fixed_price':
                    // Fixed price is entered in base currency
        ...
        async save(status = 'active') {
            ...
            try {
                ...
                if (data.success) {
                    this.showToast('Bundle erfolgreich erstellt!', 'success');
                    setTimeout(() => {
        ...
        collectFormData(status) {
            ...
            return {
                id: document.getElementById('bundleId').value || 0,
